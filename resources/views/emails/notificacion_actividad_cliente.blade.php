...
<body>
    ...
    <div class="content" style="margin:90px 90px 150px 90px;">
        ...
        Nos complace informarle que la actividad correspondiente a <strong>{{ $actividad->nombre }}</strong> ha sido
        ...
        AP Asesores Contables Integrales <br>
        {{ Auth::user()->email }}
    </div>
    
    <small>
        Este correo es exclusivamente informativo. <br>
        Saludos, AP Asesores Contables Integrales
    </small><br><br>
    <small>
        ...
        apasesorescontables@gmail.com y eliminando cualquier copia que pueda tener del mismo. Si no es el destinatario, no
        podrá
    ...
    <small>
        ...
        apasesorescontables@gmail.com and delete any copies you may have. If you are not the intended recipient, you are not
