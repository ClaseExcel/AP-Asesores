...
<body>
    ...
    <div class="content">
    <h2 style="color:#D0AA66;">Estimado {{ $data['nombre_empresa'] }},</h2>
    </div>
    ...
    <p style="color:#616161;">Atentamente,<br>AP Asesores Contables Integrales.</p>
    <br>
    @if($data['observacion_correo'])
    <h3 style="color:#D0AA66;">Observación</h3>
