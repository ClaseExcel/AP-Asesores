                        ...
                        <tr>
                            <td>
                                <animated-icons
                                    ...
                                    trigger="click"
                                    attributes='{"variationThumbColour":"#536DFE","variationName":"Two Tone","variationNumber":2,"numberOfGroups":2,"backgroundIsGroup":false,"strokeWidth":1,"defaultColours":{"group-1":"#000000","group-2":"#D0AA66","background":"#FFFFFF"}}'
                        ...
                        <div class="row">
                            <div class="col-xl-12 justify-content-center"
                                ...
                                <animated-icons
                                    ...
                                    trigger="hover"
                                    attributes='{"variationThumbColour":"#536DFE","variationName":"Two Tone","variationNumber":2,"numberOfGroups":2,"backgroundIsGroup":false,"strokeWidth":1,"defaultColours":{"group-1":"#000000","group-2":"#D0AA66","background":"#FFFFFFFF"}}'
                                    height="50" width="50">
                                </animated-icons>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3" style="display: flex; align-items: center; justify-content: center; gap:1px;">
                            <animated-icons
                                ...
                                trigger="hover"
                                attributes='{"variationThumbColour":"#536DFE","variationName":"Two Tone","variationNumber":2,"numberOfGroups":2,"backgroundIsGroup":false,"strokeWidth":1.5,"defaultColours":{"group-1":"#000000","group-2":"#D0AA66","background":"#FFFFFFFF"}}'
                                height="25" width="25">
                            </animated-icons>
