...
<head>
    ...
    <style>
        ...
        h2 { text-align: center; background-color: #D0AA66; color: white; padding: 10px; }
        ...
        th { background-color: #D0AA66; color: white; }
    ...
    <table style="width: 100%; border-collapse: collapse;border:none;">
        <tr>
            ...
            <td style="width: 50%; text-align: center; font-size: 14px;border:none;">
                ...
                <strong style="color:#D0AA66">desde: {{$fechainicio}}</strong><br>
