<div class="row">
    ...
    <div class="col-12 col-md-6">
        <div class="form-floating mb-3">
            ...
            <label for="asistentes_help" class="fw-normal">Asistentes AP Asesores Contables Integrales </label>
    ...
    <div class="col-12">
        <div class="mb-3">
            <label for="compromisos" class="fw-normal">Compromisos AP Asesores Contables Integrales </label>
