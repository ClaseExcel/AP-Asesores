...
<body>
      <div class="banner" style="margin-bottom:30px;">
        <img src="{{ public_path('./images/logos/logo_contable.png') }}" alt="AP Asesores Contables Integrales" height="90px">
    </div>
    ...
    <table style="width:100%;">
        <tr>
            <th colspan="5">DESARROLLO DE LA ACTIVIDAD</th>
        </tr>
        <tr style="background-color:#D0AA66;">
            <th>Tipo</th>
            <th>Fecha</th>
            <th>Inicio</th>
            <th>Fin</th>
