...
@section('title', 'Informe actividades especificas por usuario')
@section('content')
        ...
        <div class="col-12 col-md-8">
            <div class="card">
                <div class="card-header fs-5">
                    Informe de actividades especifico por usuario
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-12">
                                        <div class="form-floating mb-3">
                                            ...
                                            <label class="fw-normal" for="tipo_actividad_id">Tipo de actividad</label>
                    ...
                    <form method="GET" action="{{ route('admin.pdf-actividades') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <label for="actividad_id" class="fw-normal">&nbsp; # Actividad</label>
                                @error('actividad_id')
