...
class CambiarEstadoActividad extends Component
{
    ...
    public function cambiarEstado()
    {
        ...
        foreach ($ids as $id) {
            ...
            $reporteActividad = ReporteActividad::find($actividad->reporte_actividad_id);
            $estado = EstadoActividad::find($this->idEstado);
            ...
            if ($this->idEstado == 3 || $this->idEstado == 9) {
                ...
                if ($reporteActividad->justificacion) {
                    ...
                    $seguimiento[] = [
                        ...
                        'descripcion' => str_replace('&', '&amp;', $this->justificacion),
