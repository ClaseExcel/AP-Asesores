...
class EmpresaController extends Controller
{
    ...
    public function store(CreateEmpresaRequest $request)
    {
        ...
        $usuarios_eps = json_encode($request->usuario_eps);
        $clave_eps = json_encode($request->usuario_clave_eps);
        $usuarios_afp = json_encode($request->usuario_afp);
        $clave_afp = json_encode($request->clave_afp);
        $usuarios_pila = json_encode($request->usuario_pila);
        $clave_pila = json_encode($request->clave_pila);
